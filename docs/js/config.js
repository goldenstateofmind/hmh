...
var inputMortgageRate = {
  ...
  "type": "text",
  "data-format": "0.0%",
  "value": numeral(3.6/100).format('0.0%')
}
...
var inputEstInflationRate = {
  ...
  "type": "text",
  "data-format": "0%",
  "value": numeral(2/100).format('0%')
}

var inputPropertyTaxRate = { // https://sftreasurer.org/property-taxes
